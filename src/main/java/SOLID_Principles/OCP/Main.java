...
public class Main{
    public static void main(String[] args) {
        ...
        System.out.println("Manager Bonus: " + managerBonusProcessor.processBonus(chandra));
         ...
         IBonusCalculator developerBonusCalcaulator = new DeveloperBonusCalcaulator();
         BonusProcessor developerBonusProcessor = new BonusProcessor(developerBonusCalcaulator);
        System.out.println("Developer Bomus: " + developerBonusProcessor.processBonus(chandra));
